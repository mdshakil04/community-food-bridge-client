      ...
      <div className=" lg:mt-8 md:grid lg:grid-cols-3 md:grid-cols-1 justify-center items-center lg:ml-32">
        ...
        <motion.div
          ...
          <div className="">
            <img
              ...
              src="https://i.ibb.co/T8Vkdxq/1.png"
              alt=""
            />
          </div>
          <div className="card md:w-[280px] card-body  bg-white border-4 border-green-300 shadow-xl relative md:-top-52 md:left-16 md:py-12">
            ...
            <p>
              Collecting funds is a common practice used by various
              organizations, charities, and individuals to raise money....
            </p>
        ...
        <div className=" card">
          <div>
            <img
              className="rounded-xl"
              src="https://i.ibb.co/wCxvvzS/2.png"
              alt=""
            />
          </div>
          <div className="card md:w-[280px] card-body bg-white  border-4 border-green-300 shadow-xl relative md:-top-52 md:left-16 md:py-12">
            ...
            <p>
              A blood donation camp is an organized event where individuals
        ...
        <div className=" card">
          <div>
            <img
              className="rounded-xl"
              src="https://i.ibb.co/yg8b9vV/3.png"
              alt=""
            />
          </div>
          <div className="card md:w-[280px] card-body bg-white  border-4 border-green-300 shadow-xl relative md:-top-52 md:left-16 md:py-12">
            ...
            <p>
              A friendly volunteer is an individual who selflessly dedicates
              their time, energy, and skills to support various....
            </p>
            <button className="btn btn-outline btn-success  mt-4">
              Read More
            </button>
